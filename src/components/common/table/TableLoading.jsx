...
// import loadingImg from "assets/images/svgImages/tableLoading.svg";

export default function TableLoading({ className, ...rest }) {
  return (
    <Fragment>
      <div className="absolute w-full h-full bg-[#f1f5f9] opacity-75 z-10 overflow-hidden flex justify-center align-middle">
