...
const SizeChart = ({
  ...
  var serviceCall = type == productType.StoreBuilder ? SizeChartService.getsizechartdropdownbybrandidwithstoreid : SizeChartService.getsizechartdropdownbybrandid

  let distinctX = [];
  let distinctY = [];
  const schema = Yup.object({
    [fetchFieldProperty("dbfield", "sizechart")]:
