...
const Pricing = ({
  ...
  const schema = Yup.object().shape({
    ourCost: Yup.string().required(ValidationMsgs.masterCatalog.pricing.ourCostRequired).min(0.1, ValidationMsgs.masterCatalog.pricing.ourCostRequired),
    msrp: Yup.number().required(ValidationMsgs.masterCatalog.pricing.msrpRequired).min(0.1, ValidationMsgs.masterCatalog.pricing.msrpRequired),
    ...
    salePrice: Yup.number().required(ValidationMsgs.masterCatalog.pricing.salePriceRequired).min(0.1, ValidationMsgs.masterCatalog.pricing.salePriceRequired),
                    ...
                    <div className="w-full md:w-auto">
                      ...
                      <div className="relative grow">
                        ...
                        <InputNumber
                          ...
                          name="ourCost"
                          placeholder="00.00"
                          className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded p-4 py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white pl-10"
                          onChange={(e) => {
                      ...
                      <div className="w-full">
                        ...
                        <div className="flex pt-5">
                            ...
                            <Dropdown
                              ...
                              onChange={(data) => {
                                ...
                                if (data) {
                                  ...
                                  setFieldValue("quantityDiscountTemplate", "");
                                }
                              }}
                              isDisabled={readOnly}
                          ...
                          <div className="">
                            ...
                            <button type="button" className="btn border-indigo-300 hover:border-indigo-400 text-indigo-500" onClick={() => setOpenConfirmationModal(true)} ><span className="">Add Quantity Discount</span> </button>
                          </div>
                        </div>
                      </div>
                            ...
                            <table className="table-auto w-full text-sm text-[#191919] font-semibold">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="px-2 first:pl-5 py-3">
                                    <button type="button" className={`w-6 h-6 text-indigo-500`}>
                                      {/* {saveLoading ? */}
