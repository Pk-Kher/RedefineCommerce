  ...
  const COLUMNS = [
    {
      ...
      Cell: () => {
        return values ? (
          <>
            <div className="">{values.LogoLocation} </div>
          </>
        ) : (
          "-"
        );
    ...
    },
    {
      ...
      Cell: ({ }) => {
        return values ? (
          <>
            <div className="">{values.threeDLogoLocationClass}</div>
          </>
        ) : (
          "-"
        );
    ...
    },
    {
      ...
      Cell: ({ }) => {
        return values ? (
          <>
            <div className="">{values.ourcost}</div>
          </>
        ) : (
          "-"
        );
    ...
    },
    {
      ...
      Cell: ({ }) => {
        return values ? (
          <>
            <div className="">{values.ourprice}</div>
          </>
        ) : (
          "-"
        );
    ...
    },
    {
      ...
      Cell: ({ }) => {
        return values ? (
          <>
            <div className="">{values.brandguidelines}</div>
          </>
        ) : (
          "-"
        );
