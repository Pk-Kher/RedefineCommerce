...
const TemplateHeader = ({ headerProps, setHeaderProps }) => {
  return (
    <header className="flex justify-center items-center w-full sticky inset-0 bottom-auto z-60 group">
      <div className="w-full relative">
        <div class="absolute inset-0 bg-opacity-50 bg-orange-400 items-center justify-center z-20 hidden group-hover:flex cursor-pointer">
