/*Component Name: TemplateFooter
Component Functional Details: User can create or update TemplateFooter master details from here.
      ...
      <footer className="bg-gray-800 mt-20 relative group" aria-labelledby="footer-heading">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">© 2022 Company Logo, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
