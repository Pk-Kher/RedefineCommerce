...
const Inventory = ({
  ...
  var SingleFieldUpdateService = [productType.EcommerceStore, productType.CorporateStore].includes(type) ? SingleFieldUpdateServiceStore : SingleFieldUpdateServiceMaster;
          ...
          {({ errors, setFieldValue, values }) => {
            ...
            return (
              <Form>
                ...
                {/* <div className="max-h-screen border-t border-neutral-200 overflow-y-auto" > */}
                <table className="table-auto w-full text-sm text-[#191919] font-semibold justify-between">
                  ...
                  <tbody className="h-[100px]">
                    {!GlobalLoading && APIData?.map((inventory, index) => {
                      return (
                        <TR
                ...
                {(!GlobalLoading && APIData && APIData.length <= 0) ? <p className="flex justify-center items-center p-5 rounded-t border-b sticky top-0 left-0 text-red-600 bg-white">No data found as of now.</p> : ""}
