...
const EmailTemplateModel = ({
    ...
    const validationSchema = Yup.object({
        label: Yup.string().required(ValidationMsgs.emailTemplate.emailTemplateLabelRequired),
        subject: Yup.string().required(ValidationMsgs.emailTemplate.emailTemplateSubjectRequired),
        emailBody: Yup.string().required(ValidationMsgs.emailTemplate.emailBodyRequired),
    ...
    return (
        <>
            <title> Add Email Templates </title>
            <div
                id="messageModel"
