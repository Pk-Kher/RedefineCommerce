...
const Actions = ({
  ...
  return (
    <div x-data="{ open: false }">
      ...
      <Transition
        className="z-10 absolute min-w-60 bg-white border border-neutral-200 pt-1.5 rounded shadow-lg mt-1 overflow-y-auto enter-done right-20"
        show={show}
        tag="div"
                    ...
                    <li
                      ...
                      onClick={() => {
                        setModalInfo((prev) => {
                          return {
                            ...prev,
                            title: RecStatusValueName.Inactive,
                            module: "Category",
                    ...
                    <li
                      ...
                      onClick={() => {
                        setModalInfo((prev) => {
                          return {
                            ...prev,
                            title: RecStatusValueName.Active,
                            module: "Category",
