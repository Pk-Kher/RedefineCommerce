...
const Actions = ({ id, row, setOpenDeleteModal, setOpenBasicModal, setModalInfo, setOpenCreateModal }) => {
      ...
      >
        <ul className="pb-4" ref={dropdown}>
          <li className="pt-4 px-5">
            <button
              type="button"
              className="text-indigo-500 hover:text-indigo-600 cursor-pointer" onClick={() => { setOpenCreateModal(prev => !prev); setModalInfo({ data: row?.original }) }}
            >
              Edit
            </button>
          </li>
          ...
          {(permission?.isEdit || permission.isDelete) &&
            <>
              {(() => {
                      ...
                      onClick={() => {
                        setModalInfo((prev) => {
                          return {
                            ...
                            module: "Module",
                            title: "Inactive this App config",
                ...
                } else if (row?.original?.recStatus === RecStatusValuebyName.Inactive) {
                  return (
                    <li
                      className="pt-4 px-5"
                      onClick={() => {
