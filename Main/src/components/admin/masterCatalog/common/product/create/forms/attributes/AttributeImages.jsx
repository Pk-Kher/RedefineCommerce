...
import { blobFolder, defaultImage, RecStatusValuebyName } from "global/Enum";
...
const AttributeImages = ({ CombinationData, getCombinationData, valueByID, readOnly, ImageAPI, type, productId, moduleName, getProductReadinessData, checkProductStatus, setIsError,
                        ...
                        <>
                            ...
                            <div className="mt-10 border-t-2 border-neutral-200">
                                <div className="w-full p-6 pb-0 flex flex-wrap items-center justify-between mb-2">
                                    ...
                                    {((permission?.isEdit || permission?.isDelete) && (ImageData.length > 0) && !readOnly) &&
                                        <>
                                            {GlobalLoading ?
