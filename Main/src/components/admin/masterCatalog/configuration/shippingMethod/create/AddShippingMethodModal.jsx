...
const AddShippingMethodModal = ({
  ...
  }, [getStoreDropdownData, getShippingServiceDropDownData]);
  ...
  function updateShippingMethod(fields, resetForm) {
    dispatch(setAddLoading(true));
  ...
  const validationSchema = Yup.object({
    name: Yup.string().required(ValidationMsgs.shippingMethod.nameRequired),
    shippingVia: Yup.string().required(
      ValidationMsgs.shippingMethod.shippingVia
    ),
    charges: Yup.number().required(ValidationMsgs.shippingMethod.charges),
    storeId: Yup.string().required(
      ValidationMsgs.shippingService.storeIdRequired
    ),
    shippingServicesId: Yup.string().required(
      ValidationMsgs.shippingMethod.shippingServicesIdRequired
    ),
  });
                      ...
                      <div className="p-6">
                        ...
                        <div className="w-full mb-4 last:mb-0">
                          ...
                          <ToggleButton
                            ...
                            defaultValue={
                              values.isClient === true ? true : false
                            }
                          />
                        </div>
                        <div className="w-full mb-4 last:mb-0">
                          ...
                          <ToggleButton
                            ...
                            defaultValue={
                              values.isAdmin === true ? true : false
                            }
                          />
                        </div>
