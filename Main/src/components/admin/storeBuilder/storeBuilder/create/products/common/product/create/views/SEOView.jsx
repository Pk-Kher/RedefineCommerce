...
const SEOView = ({ displayFieldElement, fetchFieldProperty, fields, values, requiredFields, tab, type, setActiveTab, index, productId }) => {
                                    ...
                                    <div className="mb-6">
                                        <div className={`mb-3 text-base bg-white py-4 rounded ${preview === 'desktop' ? 'w-full' : ' w-2/4'}`}>
                                            <div className="text-sm leading-4 text-[#202124] flex py-1 font-arial">
                                                <span className="cursor-pointer" title="">https://www.corporategear.com › ... <span className="material-icons-outlined text-[15px]">more_vert</span></span>
                                            </div>
                                            <div className="text-[20px] text-[#1a0dab] font-arial leading-6 py-1"><span className="cursor-pointer" title="">Corporate Gear</span></div>
                                            <div className="text-sm text-black leading-6 mb-2">
                                                <div className="text-[14px] leading-[22px] text-[#4d5156] mb-2 mr-2 inline-block font-arial">
                                                    <span className="font-bold">Corporate Gear</span> gives its customers exclusive, direct access to custom branded clothing and accessories from iconic premium sports and lifestyle brands.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="mb-6">
                                    <label className="tracking-wide text-gray-700 text-sm font-bold mb-2 flex items-center">
                                        ...
                                        <div className="relative inline-block ml-2" x-data="{ open: false }">
                                            <button className=""><span className="material-icons-outlined text-sm">info</span></button>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <label className="tracking-wide text-gray-700 text-sm font-bold mb-2 flex items-center">
                                            ...
                                            <div className="relative" x-data="{ open: false }">
                                                <button className="" ><span className="material-icons-outlined ml-2 text-sm">info</span></button>

                                            </div>
                                        </label>
                                    </div>
                                    <div className="">{Data?.pageTitle}</div>
                                </div>
                                <div className="mb-6">
                                    <div className="flex items-center justify-between">
                                        <label className="tracking-wide text-gray-700 text-sm font-bold mb-2 flex items-center">
                                    ...
                                    <div className="">{Data?.metaDescription}</div>
                                </div >
                                <div className="mb-6">
                                    <div className="flex items-center justify-between">
                                        <label className="tracking-wide text-gray-700 text-sm font-bold mb-2 flex items-center">
                                    ...
                                    <div className="">{Data?.metaKeywords}</div>
                                </div >
                            </div >
                        </div >
                    </div >
                                ...
                                <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                                    <div className="w-full md:w-1/2 px-4 mb-4">
                                        <span className="cursor-pointer block mb-4 active" title="" aria-expanded="true">
                                            {/* <img src={`${process.env.REACT_APP_API_BLOB}${Data?.openGraphImagePath}`} alt="" title="" /> */}
                                            <img className=" h-44 min-h-full mx-auto rounded-t-md" src={`${process.env.REACT_APP_API_BLOB}${Data?.openGraphImagePath}`} alt="" />
                                        </span>
                                    ...
                                    <div className="w-full md:w-1/2 px-4 mb-4">
                                        <div className="mb-6">
                                            ...
                                            <div className="">{Data?.openGraphTitle} </div>
                                        </div>
                                        <div className="mb-6">
                                            <div className="flex items-center justify-between">
                                                <label className="tracking-wide text-gray-700 text-sm font-bold mb-2 flex items-center">
                                            ...
                                            <div className="">{Data?.openGraphDescription} </div>
                                        </div >
                                    </div >
                                </div >
                            </div >
                                    ...
                                    <li className="w-full">
                                        ...
                                        <div className="relative text-sm overflow-hidden duration-700">
                                            <div className="mt-6">
                                                <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                                                    <div className="w-full md:w-1/2 px-4 mb-4">
                                                        {/* <div className="p-0 h-auto"><img className=" h-44 min-h-full mx-auto rounded-t-md" src={`${process.env.REACT_APP_API_BLOB}${Data?.facebookImagePath}`} alt="" /></div> */}
                                                        <SocialPreview fields={fields} displayFieldElement={displayFieldElement} imageUrl={`${process.env.REACT_APP_API_BLOB}${Data?.facebookImagePath}`} socialIcon={facebookIcon} title={Data?.facebookOpenGraphTitle} description={Data?.facebookOpenGraphDescription} />
                                                    </div>
                                                    <div className="w-full md:w-1/2 px-4 mb-4">
                                                        <SocialPreview fields={fields} displayFieldElement={displayFieldElement} imageUrl={`${process.env.REACT_APP_API_BLOB}${Data?.twitterImagePath}`} socialIcon={twitterIcon} title={Data?.twitterOpenGraphTitle} description={Data?.twitterOpenGraphDescription} />
                                                    </div>
                                                    <div className="w-full md:w-1/2 px-4 mb-4">
                                                        <SocialPreview fields={fields} displayFieldElement={displayFieldElement} imageUrl={`${process.env.REACT_APP_API_BLOB}${Data?.linkedinImagePath}`} socialIcon={linkedinIcon} title={Data?.linkedinOpenGraphTitle} description={Data?.linkedinOpenGraphDescription} />
                                                    </div>
                                                    <div className="w-full md:w-1/2 px-4 mb-4">
                                                        <SocialPreview fields={fields} displayFieldElement={displayFieldElement} imageUrl={`${process.env.REACT_APP_API_BLOB}${Data?.pinterestImagePath}`} socialIcon={pinterestIcon} title={Data?.pinterestOpenGraphTitle} description={Data?.pinterestOpenGraphDescription} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
const SocialPreview = ({ socialIcon, name, description, title, fields, displayFieldElement, imageUrl }) => {
    ...
    const FolderPath = `/${blobFolder.temp}/${CompanyId}/${blobFolder.seoViews}`
    ...
    return (
        <>
            <div className="border border-gray-200 p-4">
                ...
                {displayFieldElement(fields, `${name}_image`) && (
                    <ImageFile
                        type="file"
                        className="sr-only"
                        name={`${name}_image`}
                ...
                {imageUrl !== '' ? (
                    <>
                        ...
                        <div className="flex justify-between">
                            <label className="tracking-wide text-gray-700 text-sm leading-4 flex items-center" htmlFor="">We recommend 1,200px by 628px.</label>
